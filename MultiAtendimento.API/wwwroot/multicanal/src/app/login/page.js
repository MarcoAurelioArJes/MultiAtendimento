  ...
  return (
    <div className="isolate bg-gray-50 px-6 py-24 sm:py-32 lg:px-8 ">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Entrar</h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Tela para entrar no sistema
        </p>
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={entrar}>
