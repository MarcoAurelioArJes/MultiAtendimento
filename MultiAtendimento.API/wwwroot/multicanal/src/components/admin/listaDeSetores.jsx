...
export default function ListaDeSetores() {
    ...
    useEffect(() => {
        setorRepositorio.obterSetores().then(data => setSetores(data.resultado))
    },[])
                        ...
                        <li key={setor.id} className="flex justify-between gap-x-6 py-5">
                            <div className="flex min-w-0 gap-x-4">
                                <div className="min-w-0 flex-auto">
                                    <p className="text-sm font-semibold leading-6 text-gray-900">{setor.nome}</p>
                                </div>
                            </div>
                            <div className="flex gap-x-4">
                                ...
                                <button
                                    ...
                                    onClick={() => handleDeleteButtonClick("setor", setor.id)}
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <li className="flex justify-end gap-x-6 py-5 text-white">
                        <div className="flex gap-x-4">
                            <button
                                ...
                                onClick={handleAoClicarEmNovoSetor}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
